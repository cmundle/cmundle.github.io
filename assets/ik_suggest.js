(function ( $, window, document) {
  ...
  var pluginName = "ik_suggest",
    defaults = {
      "instructions": "When you start typing the application may suggest search terms. Use up and down arrow keys to select a suggested search term.",
      "minLength": 2,
      "maxResults": 10,
      "source": []
    };
     ...
     * @param {number} options.minLength - Minimum string length before suggestions start showing.
